...
class LPIPS(nn.Module):
    def __init__(self, pretrained=True, net='alex', version='0.1', lpips=True, spatial=False, 
        pnet_rand=False, pnet_tune=False, use_dropout=True, model_path=None, net_path=None, eval_mode=True, verbose=True):
        ...
        if(net_path is None):
            self.net = net_type(pretrained=not self.pnet_rand, requires_grad=self.pnet_tune, model_path=None)
        else:
            self.net = net_type(pretrained=not self.pnet_rand, requires_grad=self.pnet_tune, model_path=net_path)
