...
if __name__ == "__main__":
    ...
    parser.add_argument("-loop_smpl", "--loop_smpl", type=int, default=100)  # default=50
    parser.add_argument("-patience", "--patience", type=int, default=5)
    parser.add_argument("-in_dir", "--in_dir", type=str, default="/apdcephfs/private_eckertzhang/Codes/Results/data_human_images")
    parser.add_argument("-out_dir", "--out_dir", type=str, default="/apdcephfs/private_eckertzhang/Codes/Results/Results_ECON")
