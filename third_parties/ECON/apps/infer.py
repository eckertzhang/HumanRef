...
if __name__ == "__main__":
    ...
    parser.add_argument("-in_dir", "--in_dir", type=str, default="/apdcephfs/private_eckertzhang/Codes/Results/data_human_images/image_000012.png")
    parser.add_argument("-out_dir", "--out_dir", type=str, default="/apdcephfs/private_eckertzhang/Codes/Results/Results_ECON/image_000012")
